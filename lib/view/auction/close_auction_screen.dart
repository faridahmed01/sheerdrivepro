...
class CloseAuctionScreen extends StatefulWidget {
  const CloseAuctionScreen({
    super.key,
  });

  @override
  State<CloseAuctionScreen> createState() => _CloseAuctionScreenState();
}

class _CloseAuctionScreenState extends State<CloseAuctionScreen> {
  String bodytext =
